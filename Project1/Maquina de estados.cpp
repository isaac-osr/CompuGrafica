...
//Anim
float rotBall = 0.0f;//para la pelota
bool AnimBall = false;
bool AnimDog = false;
float rotDog = 0.0f;
int dogAnim = 0;
...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//Body - Debe haber una jerarquía entonces al agregar modelos hacemos un pivote para que las partes vayan juntas
...
void Caminata() {//ya tenemos variables listas, dogrot,dogpos
	dogPos.z += 0.001;
	if (step)
	{	
		FLegs += 1.0f;
...
//Ejercicio animar al perro caminando