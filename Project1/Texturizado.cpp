...
int main()
{
	...
	GLfloat vertices[] =//cuadrado
	{
		// Positions           // Colors           // Texture Coords	Ejercicio4
		...
		//Ejercicio1: dibujar sólo el cuadrante azul (inferoir derecha)
		//Ejercicio2: dibujar cuadrante superior izq
		//Ejercicio3: cuadro al centro
		//Ejercicio4: que muestre 27 ventanas (3x9)
		//Ejercicio5: que muestre 3 y 1/2 ventanas en fila y repetir 5 veces la fila hacia abajo
	};
	...
	// Diffuse map
	image = stbi_load("images/window.png", &textureWidth, &textureHeight, &nrChannels,0);//ruta de la textura
	glBindTexture(GL_TEXTURE_2D, texture1);
