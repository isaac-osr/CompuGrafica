...
#include <glm/glm.hpp> //agregada, para proyecciones
...
int main() {
	...
	//GLfloat vertices[] = {//vértices para proyeccion ortogonal
 ...
 //     
	...
	//2.- Copiamos nuestros arreglo de vertices eln un buffer de vertices para que OpenGL o use
	...
	glm::mat4 projection=glm::mat4(1);//matriz 4x4 con 1 en cada elemento
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		ourShader.Use();
		glm::mat4 model=glm::mat4(1);//matriz modelo, vista
		...
		//view = glm::translate( view, glm::vec3( screenWidth / 2, screenHeight / 2,-700.0f ) ); // use with orthographic projection, traslacion a la vista
		
		GLint modelLoc = glGetUniformLocation(ourShader.Program, "model");//las atrices se mandan al shader
...
//Ejercicios: 1.-Dibujar 2 cubos extra(podemosmodifiar la vista) uno a la derecha y otro a izq y con rotación en Z 
